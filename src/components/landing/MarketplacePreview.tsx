...
import babyBasketAsset from "@/assets/baby-basket.png.asset.json";
...
const items: Item[] = [
  ...
  { name: "Baby Basket Card", maker: "Little Bloom", price: 75, rating: 4.9, tag: "New Baby", tone: "from-rose-400/30 to-pink-300/20", h: "h-56", img: babyBasketAsset.url },
